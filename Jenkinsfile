pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/brownc61'                                                 // <------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/brownc61/225-lab3-2.git'                   // <------change this
        KUBECONFIG = credentials('brownc61-225')                                             // <------change this
    }
